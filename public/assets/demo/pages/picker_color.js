...
const ColorPicker = function() {
    ...
    const _componentColorPicker = function() {
        ...
        const toggleState = document.querySelector('#enable_picker');
        ...
        $('.colorpicker-event-change').spectrum({
            change: function(c) {
                const label = $('#change-result');
                label.removeClass('d-none').html('Change called: ' + '<span class="font-weight-semibold">' + c.toHexString() + '</span>');
            }
        });
        ...
        $('.colorpicker-event-move').spectrum({
            move: function(c) {
                ...
                label.removeClass('d-none').html('Move called: ' + '<span class="font-weight-semibold">' + c.toHexString() + '</span>');
            }
        });
        ...
        $('.colorpicker-event-hide').spectrum({
            hide: function(c) {
                const label = $('#hide-result');
                label.removeClass('d-none').html('Hide called: ' + '<span class="font-weight-semibold">' + c.toHexString() + '</span>');
            }
        });
        ...
        $('.colorpicker-event-show').spectrum({
            show: function(c) {
                const label = $('#show-result');
                label.removeClass('d-none').html('Show called: ' + '<span class="font-weight-semibold">' + c.toHexString() + '</span>');
            }
        });
        ...
        $('.colorpicker-event-dragstart').on('dragstart.spectrum', function (e, c) {
            const label = $('#dragstart-result');
            label.removeClass('d-none').html('Dragstart called: ' + '<span class="font-weight-semibold">' + c.toHexString() + '</span>');
        });
        ...
        $('.colorpicker-event-dragstop').on('dragstop.spectrum', function (e, c) {
            const label = $('#dragstop-result');
            label.removeClass('d-none').html('Dragstop called: ' + '<span class="font-weight-semibold">' + c.toHexString() + '</span>');
        });
    };
