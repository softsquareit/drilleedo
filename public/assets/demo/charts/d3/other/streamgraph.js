            ...
            d3.csv("../../../assets/demo/data/dashboard/traffic_sources.csv", function (error, data) {
                ...
                d3Container
                    .on("mousemove", function (d, i) {
                        ...
                        tooltip.style("top", (mousey - (document.querySelector('.d3-tip').getBoundingClientRect().height / 2)) - 2 + "px") 
                        ...
                        if(mousex >= (element.getBoundingClientRect().width - document.querySelector('.d3-tip').getBoundingClientRect().width - margin.right - (tooltipOffset * 2))) {
                            tooltip
                                .style("left", (mousex - document.querySelector('.d3-tip').getBoundingClientRect().width - tooltipOffset) + "px") 
                                .attr("class", "d3-tip w");
                        }
                        else {
                            tooltip
