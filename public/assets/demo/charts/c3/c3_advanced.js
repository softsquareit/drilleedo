...
const С3Advanced = function() {
    ...
    const _advancedExamples = function() {
        ...
        const transform_element = document.getElementById('c3-transform');
        const zoomable_element = document.getElementById('c3-chart-zoomable');
        const subchart_element = document.getElementById('c3-subchart');
        const label_format_element = document.getElementById('c3-label-format');
        const data_color_element = document.getElementById('c3-data-color');
        ...
        if(zoomable_element) {
            ...
            const zoomable_chart = c3.generate({
        ...
        if(label_format_element) {
            ...
            const label_format = c3.generate({
